...
2. 기능 검증: 어떤 기능이 핵심기능이고 기능 정의가 좋은지 타겟칭을 고려했을때 필요 없을 거 같은 기능들을 대시보드 형식으로 분석을 제공한다
3. 컨셉 테스트: 타겟 페르소나들이 실제로 이 서비스에 대한 컨셉을 어떻게 생각하는지 장단점은 무엇인지를 도출하고 리포트로써 제공한다

- 전체 산출물: 서비스 적합도 리포트 + 타겟층 인터뷰 리뷰 
...
### ④ 마케팅 제작지원
1. 각각의 리포트 내용들을 바탕으로 타겟 고객층들에게 어필 될 수 있는 광고 구성을 제작
    카피 A/B를 타겟 페르소나에게 사전 테스트 → 출시 전략 리포트
